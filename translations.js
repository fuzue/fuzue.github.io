const T = {
  en: {
    ...
    ri4_badge: "Ongoing",
    ri4_text: "The open-source tools (GUIbiont, AutoGate, ChiBio Next) are developed with the same rigor - documented, tested, and built to outlast the turnover of a research group.",
  ...
  it: {
    ...
    ri4_badge: "In corso",
    ri4_text: "Gli strumenti open-source (GUIbiont, AutoGate, ChiBio Next) sono sviluppati con lo stesso rigore - documentati, testati e costruiti per sopravvivere al ricambio di un gruppo di ricerca.",
  ...
  pt: {
    ...
    ri4_text: "As ferramentas open-source (GUIbiont, AutoGate, ChiBio Next) são desenvolvidas com o mesmo rigor - documentadas, testadas e construídas para durar além da rotatividade de um grupo de pesquisa.",
  ...
  pl: {
    ...
    ri4_badge: "W toku",
    ri4_text: "Narzędzia open-source (GUIbiont, AutoGate, ChiBio Next) są rozwijane z taką samą rzetelnością - udokumentowane, przetestowane i zbudowane tak, aby przetrwać rotację w grupie badawczej.",
