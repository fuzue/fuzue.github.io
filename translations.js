const T = {
  en: {
    ...
    cluster_lab_credit: "Developed in active collaboration with the <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Pinheiro Group</a> at <a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>.",
    oss_status: "In development",
    guibiont_desc: "A browser-based application for microbial growth phenotyping from plate-reader data - quality control, curve inspection, fitting across 30+ parametric and ODE models, trajectory clustering, batch processing, and metadata-linked statistical interpretation. No code required, and every analysis exports as an executable Julia script built on KinBiont.jl, so the interactive session stays reproducible.",
    guibiont_preprint_link: "Read the bioRxiv preprint →",
    cytometrika_desc: "Automated gating for flow cytometry data. Removes the manual, subjective step of population gating with a reproducible, algorithm-driven pipeline - built to integrate with research workflows and produce publication-ready results.",
    chibio_desc: "A modular rewrite of the chi.bio bioreactor operating system with a hexagonal hardware abstraction - the same control loops run unchanged on real I²C hardware or against a Python physics simulator, with regression tests against real culture data.",
    ...
    bayesbiont_desc: "The Bayesian companion to KinBiont.jl. Samples the full posterior with NUTS via Turing.jl, supports hierarchical pooling across replicates with a non-centered reparameterisation, and compares competing models with PSIS-LOO. For when calibrated uncertainty and principled model comparison matter.",
    ...
    alr_status: "Living",
    alr_desc: "A research-oriented, continuously-updated reference for modern AI - deep learning, foundation models, large language models, generative models, reinforcement learning, agents, interpretability, alignment, causality. Content licensed CC&nbsp;BY-SA&nbsp;4.0; chapters revised in place as the field moves.",
    alr_tag_book: "Book",
    alr_tag_modern_ai: "Modern AI",
    alr_tag_open_knowledge: "Open knowledge",
    scipeer_desc: "AI reasoning partner for researchers - builds a persistent knowledge graph from your work. Every AI session starts knowing what you've done, what you've tried, and why. Connects experiments, literature, instruments, and decisions.",
    scipeer_beta: "Private beta",
    ...
    ri5_badge: "Preprint",
    ri5_text: "<strong>bioRxiv</strong> - <em>No-code microbial growth phenotyping with GUIbiont</em>, Alvarenga, Oltolini &amp; Pinheiro. Validated across 3,885 <em>E. coli</em> deletion strains and 13,608 defined-media growth curves.<a href=\"https://www.biorxiv.org/content/10.64898/2026.08.17.745250v1\" target=\"_blank\">Read the preprint →</a>",
    ri2_badge: "In progress",
    ri2_text: "Two further publications forthcoming - ongoing collaboration with the <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Pinheiro Group</a> at <a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>, Milan.",
    ...
    ri4_badge: "Ongoing",
    ri4_text: "The open-source tools (GUIbiont, Cytometrika, ChiBio Next) are developed with the same rigor - documented, tested, and built to outlast the turnover of a research group.",
    ...
    work1_p2: "The software work contributed directly to a peer-reviewed publication in <em>Nature Communications</em> - listed under Fuzue Tech as the affiliated company. This is the basis of the #11 ranking among Polish companies in the Nature Index, and a rare distinction for a company in any field.",
  ...
  it: {
    ...
    cluster_lab_credit: "Sviluppato in collaborazione con il <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Gruppo Pinheiro</a> all'<a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>.",
    oss_status: "In sviluppo",
    guibiont_desc: "Un'applicazione via browser per il fenotipaggio della crescita microbica a partire dai dati dei lettori di piastre - controllo qualità, ispezione delle curve, adattamento con oltre 30 modelli parametrici e a ODE, clustering delle traiettorie, elaborazione in batch e interpretazione statistica collegata ai metadati. Senza scrivere codice, e ogni analisi viene esportata come script Julia eseguibile basato su KinBiont.jl, così la sessione interattiva resta riproducibile.",
    guibiont_preprint_link: "Leggi il preprint su bioRxiv →",
    cytometrika_desc: "Gating automatico per dati di citometria a flusso. Elimina il passaggio manuale e soggettivo del gating con una pipeline riproducibile e algoritmica - integrata nei flussi di lavoro di ricerca per risultati pronti alla pubblicazione.",
    chibio_desc: "Una riscrittura modulare del sistema operativo del bioreattore chi.bio con un'astrazione hardware esagonale - gli stessi loop di controllo girano invariati su hardware I²C reale o su un simulatore fisico in Python, con test di regressione su dati di colture reali.",
    ...
    alr_status: "In divenire",
    alr_desc: "Un riferimento sull'IA moderna orientato alla ricerca e aggiornato in continuo - deep learning, modelli fondazionali, large language model, modelli generativi, reinforcement learning, agenti, interpretabilità, allineamento, causalità. Contenuti con licenza CC&nbsp;BY-SA&nbsp;4.0; i capitoli sono revisionati in loco man mano che il campo evolve.",
    alr_tag_book: "Libro",
    alr_tag_modern_ai: "IA moderna",
    alr_tag_open_knowledge: "Conoscenza aperta",
    scipeer_desc: "Partner AI per la ricerca - costruisce un grafo di conoscenza persistente dal tuo lavoro. Ogni sessione AI inizia sapendo cosa hai fatto, cosa hai provato e perché. Collega esperimenti, letteratura, strumenti e decisioni.",
    scipeer_beta: "Beta privata",
    ...
    ri5_badge: "Preprint",
    ri5_text: "<strong>bioRxiv</strong> - <em>No-code microbial growth phenotyping with GUIbiont</em>, Alvarenga, Oltolini &amp; Pinheiro. Validato su 3.885 ceppi di delezione di <em>E. coli</em> e 13.608 curve di crescita in terreni definiti.<a href=\"https://www.biorxiv.org/content/10.64898/2026.08.17.745250v1\" target=\"_blank\">Leggi il preprint →</a>",
    ri2_badge: "In corso",
    ri2_text: "Due ulteriori pubblicazioni in arrivo - collaborazione in corso con il <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Gruppo Pinheiro</a> all'<a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>, Milano.",
    ...
    ri4_badge: "In corso",
    ri4_text: "Gli strumenti open-source (GUIbiont, Cytometrika, ChiBio Next) sono sviluppati con lo stesso rigore - documentati, testati e costruiti per sopravvivere al ricambio di un gruppo di ricerca.",
    ...
    work1_p2: "Il lavoro software ha contribuito a una pubblicazione peer-reviewed in <em>Nature Communications</em> - elencata sotto Fuzue Tech come azienda affiliata. Questa è la base del ranking #11 tra le aziende polacche nel Nature Index.",
  ...
  pt: {
    ...
    cluster_lab_credit: "Desenvolvido em colaboração ativa com o <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Grupo Pinheiro</a> no <a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>.",
    oss_status: "Em desenvolvimento",
    guibiont_desc: "Uma aplicação no navegador para fenotipagem de crescimento microbiano a partir de dados de leitores de placas - controle de qualidade, inspeção de curvas, ajuste com mais de 30 modelos paramétricos e de EDO, agrupamento de trajetórias, processamento em lote e interpretação estatística vinculada aos metadados. Sem escrever código, e cada análise é exportada como script Julia executável baseado no KinBiont.jl, mantendo a sessão interativa reprodutível.",
    guibiont_preprint_link: "Ler o preprint no bioRxiv →",
    cytometrika_desc: "Gating automático para dados de citometria de fluxo. Elimina a etapa manual e subjetiva de gating de populações com um pipeline reproduzível e algorítmico - integrado a fluxos de trabalho de pesquisa para resultados prontos para publicação.",
    chibio_desc: "Uma reescrita modular do sistema operativo do biorreator chi.bio com uma abstração de hardware hexagonal - os mesmos loops de controle rodam inalterados em hardware I²C real ou num simulador físico em Python, com testes de regressão sobre dados de culturas reais.",
    ...
    bayesbiont_desc: "O companheiro bayesiano do KinBiont.jl. Amostra a posteriori completa com NUTS via Turing.jl, suporta pooling hierárquico entre réplicas com uma reparametrização não centrada, e compara modelos concorrentes com PSIS-LOO. Para quando a incerteza calibrada e a comparação rigorosa de modelos importam.",
    ...
    alr_status: "Vivo",
    alr_desc: "Uma referência sobre IA moderna orientada à pesquisa e atualizada continuamente - deep learning, modelos fundacionais, large language models, modelos generativos, aprendizado por reforço, agentes, interpretabilidade, alinhamento, causalidade. Conteúdo sob licença CC&nbsp;BY-SA&nbsp;4.0; os capítulos são revisados in loco à medida que o campo evolui.",
    alr_tag_book: "Livro",
    alr_tag_modern_ai: "IA moderna",
    alr_tag_open_knowledge: "Conhecimento aberto",
    scipeer_desc: "Parceiro de raciocínio de IA para pesquisadores - constrói um grafo de conhecimento persistente a partir do seu trabalho. Cada sessão de IA começa sabendo o que você fez, o que tentou e por quê. Conecta experimentos, literatura, instrumentos e decisões.",
    scipeer_beta: "Beta privado",
    ...
    ri5_badge: "Preprint",
    ri5_text: "<strong>bioRxiv</strong> - <em>No-code microbial growth phenotyping with GUIbiont</em>, Alvarenga, Oltolini &amp; Pinheiro. Validado em 3.885 linhagens de deleção de <em>E. coli</em> e 13.608 curvas de crescimento em meios definidos.<a href=\"https://www.biorxiv.org/content/10.64898/2026.08.17.745250v1\" target=\"_blank\">Ler o preprint →</a>",
    ri2_badge: "Em andamento",
    ri2_text: "Duas publicações adicionais a caminho - colaboração contínua com o <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Grupo Pinheiro</a> no <a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>, Milão.",
    ...
    ri4_text: "As ferramentas open-source (GUIbiont, Cytometrika, ChiBio Next) são desenvolvidas com o mesmo rigor - documentadas, testadas e construídas para durar além da rotatividade de um grupo de pesquisa.",
    ...
    work1_p2: "O trabalho de software contribuiu diretamente para uma publicação revisada por pares na <em>Nature Communications</em> - listada sob o nome Fuzue Tech como empresa afiliada. Esta é a base do ranking #11 entre empresas polonesas no Nature Index.",
  ...
  pl: {
    ...
    cluster_lab_credit: "Rozwijane we współpracy z <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Grupą Pinheiro</a> w <a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>.",
    oss_status: "W opracowaniu",
    guibiont_desc: "Aplikacja działająca w przeglądarce do fenotypowania wzrostu drobnoustrojów na podstawie danych z czytników płytek - kontrola jakości, inspekcja krzywych, dopasowanie ponad 30 modeli parametrycznych i opartych na równaniach różniczkowych, klastrowanie trajektorii, przetwarzanie wsadowe oraz interpretacja statystyczna powiązana z metadanymi. Bez pisania kodu, a każda analiza jest eksportowana jako wykonywalny skrypt Julia oparty na KinBiont.jl, dzięki czemu interaktywna sesja pozostaje odtwarzalna.",
    guibiont_preprint_link: "Przeczytaj preprint na bioRxiv →",
    cytometrika_desc: "Automatyczne gating dla danych cytometrii przepływowej. Eliminuje ręczny, subiektywny krok bramkowania populacji za pomocą reprodukowalnego potoku algorytmicznego - zintegrowanego z przepływami pracy badawczej.",
    chibio_desc: "Modularna przebudowa systemu operacyjnego bioreaktora chi.bio z heksagonalną warstwą abstrakcji sprzętu - te same pętle sterowania działają bez zmian na rzeczywistym sprzęcie I²C lub na symulatorze fizyki w Pythonie, z testami regresyjnymi na danych z rzeczywistych hodowli.",
    ...
    bayesbiont_desc: "Bayesowski towarzysz KinBiont.jl. Próbkuje pełny rozkład a posteriori przy użyciu NUTS przez Turing.jl, obsługuje pulę hierarchiczną między replikami z niescentralizowaną reparametryzacją, i porównuje konkurujące modele za pomocą PSIS-LOO. Gdy liczy się skalibrowana niepewność i rygorystyczne porównanie modeli.",
    ...
    alr_status: "Żywe",
    alr_desc: "Zorientowane na badania, stale aktualizowane kompendium nowoczesnej AI - głębokie uczenie, modele fundacyjne, duże modele językowe, modele generatywne, uczenie ze wzmocnieniem, agenci, interpretowalność, dostosowanie, przyczynowość. Treść na licencji CC&nbsp;BY-SA&nbsp;4.0; rozdziały aktualizowane w miejscu w miarę rozwoju dziedziny.",
    alr_tag_book: "Książka",
    alr_tag_modern_ai: "Nowoczesna AI",
    alr_tag_open_knowledge: "Otwarta wiedza",
    scipeer_desc: "Partner AI dla badaczy - buduje trwały graf wiedzy z Twojej pracy. Każda sesja AI zaczyna wiedząc, co zrobiłeś, co próbowałeś i dlaczego. Łączy eksperymenty, literaturę, instrumenty i decyzje.",
    scipeer_beta: "Prywatna beta",
    oss_released: "Wydano",
    ...
    ri5_badge: "Preprint",
    ri5_text: "<strong>bioRxiv</strong> - <em>No-code microbial growth phenotyping with GUIbiont</em>, Alvarenga, Oltolini &amp; Pinheiro. Zwalidowane na 3885 szczepach delecyjnych <em>E. coli</em> i 13 608 krzywych wzrostu w podłożach definiowanych.<a href=\"https://www.biorxiv.org/content/10.64898/2026.08.17.745250v1\" target=\"_blank\">Przeczytaj preprint →</a>",
    ri2_badge: "W toku",
    ri2_text: "Dwie kolejne publikacje w przygotowaniu - trwająca współpraca z <a href=\"https://humantechnopole.it/en/research-groups/pinheiro-group/\" target=\"_blank\">Grupą Pinheiro</a> w <a href=\"https://htechnopole.it/\" target=\"_blank\">Human Technopole</a>, Mediolan.",
    ...
    ri4_badge: "W toku",
    ri4_text: "Narzędzia open-source (GUIbiont, Cytometrika, ChiBio Next) są rozwijane z taką samą rzetelnością - udokumentowane, przetestowane i zbudowane tak, aby przetrwać rotację w grupie badawczej.",
    ...
    work1_p2: "Praca programistyczna przyczyniła się do recenzowanej publikacji w <em>Nature Communications</em> - wymienionej pod Fuzue Tech jako firma afiliowana. To podstawa rankingu #11 wśród polskich firm w Nature Index.",
